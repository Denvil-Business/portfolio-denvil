      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 reveal">
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-3 space-y-5">
            ...
            <button
              type="submit"
              className={`px-8 py-3.5 rounded-lg font-semibold text-sm transition-all duration-300 ${
                sent
                  ? 'bg-neon text-dark'
          ...
          <div className="lg:col-span-2 flex flex-col gap-8 justify-center">
            <div>
              ...
              <a href="mailto:denvilbusiness@gmail.com" className="text-neon hover:text-neon-lime text-sm transition-colors">
                denvilbusiness@gmail.com
              </a>
            </div>
